...
export default async function AppClientPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <ClientDetailView basePath="/app" client={client} invoices={data.invoices} quotes={data.quotes} />
  );
}
